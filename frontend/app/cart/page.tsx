                ...
                <div className="flex-1 space-y-1">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    <div className="flex items-center border border-outline-variant rounded-full">
                      <button className="w-9 h-9 flex items-center justify-center text-primary hover:bg-surface-container-low rounded-l-full">
                        <span className="material-symbols-outlined text-[18px]">remove</span>
                      </button>
                      <span className="w-8 text-center font-body text-body-md">{i.qty}</span>
                      <button className="w-9 h-9 flex items-center justify-center text-primary hover:bg-surface-container-low rounded-r-full">
