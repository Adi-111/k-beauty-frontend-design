...
const slides: Slide[] = [
  ...
  },
  {
    ...
    gradient: "from-on-background/85 via-on-background/40 to-transparent",
  },
  {
    href: "/shop",
    date: "Top Rated",
    ...
    gradient: "from-primary/90 via-primary/45 to-transparent",
  },
  {
    href: "/account",
    date: "New Members",
  ...
  },
  {
    ...
    image: "/products/hero-5.jpg",
    gradient: "from-on-background/85 via-on-background/35 to-transparent",
  },
];
